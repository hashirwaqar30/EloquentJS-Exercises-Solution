/* The standard JavaScript environment provides another data structure called Set. Like
an instance of Map, a set holds a collection of values. Unlike Map, it does not associate
...
class Group {
  ...
  has(value) {
    return this.group.some((i) => i === value);
  }
  ...
  static from(iterable) {
    let group = new Group();
    for (let i of iterable) group.add(i);
    return group;
  }
}
